...
if ingredients_list:
    # Build ingredient string with trailing space
    ingredients_string = " ".join([str(fruit).strip() for fruit in ingredients_list]) + " "
    ...
    st.write(f"Final ingredients string (with trailing space): '{ingredients_string}'")
